                                            ...
                                            if (dirlev2.Length > 0) {
                                                ...
                                                foreach (string s2 in dirlev2) {
                                                    ...
                                                    if (level >= 3 && level != 0) {
                                                        ...
                                                        //Вывод файлов третьего уровня.
                                                        string[] files3 = Directory.GetFiles (s2);
                                                        if (files3.Length > 0) {
                                                            Console.WriteLine ($"\t\t\tФайлы третьего уровня:");
                                                            foreach (string ss2 in files3) Console.WriteLine ($"\t\t\t{ss2}");
                                                            Console.WriteLine ($"\t\t\tНайдено файлов {files3.Length}.");
                                                        }
                                                    }
                                                }
